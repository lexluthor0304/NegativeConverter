...
export const studioText = {
  zh: {
    ...
    cyan: '青 / 红', testStrip: '试条', dodgeBurn: '加减光', flatField: '平场校正',
  ...
  en: {
    ...
    cyan: 'Cyan / red', testStrip: 'Test strip', dodgeBurn: 'Dodge and burn', flatField: 'Flat field',
  ...
  ja: {
    ...
    cyan: 'シアン / 赤', testStrip: 'テストストリップ', dodgeBurn: '覆い焼き・焼き込み', flatField: 'フラットフィールド',
  ...
  return {
    ...
    sync() {
      ...
      if (loaded) {
        ...
        ['toneSection', 'colorSection', 'cmySection', 'additionalSection', 'consoleSection', 'dustRemovalSection', 'advancedSection', 'enlargerSection', 'testStripSection', 'paperSection', 'dodgeBurnSection', 'flatFieldSection'].forEach(id => {
