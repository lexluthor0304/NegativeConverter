...
export const i18n = {
      zh: {
        ...
        exportJpeg: "导出 JPEG",
        exportTiff: "导出 TIFF",
        dustAiTitle: "AI 修复（本机运行）",
        dustAiEnable: "提交和导出时用学习型补绘填充遮罩",
        dustAiLoad: "加载模型",
        dustAiPick: "使用模型文件（.onnx）",
        dustAiStatusIdleGpu: "尚未加载模型。勾选 AI 修复或加载模型；本机有 WebGPU，会用它运行。",
        ...
        dustAiStatusError: "模型加载失败：{message}。请改为加载本地的 LaMa ONNX 文件。",
        dustAiStatusRunning: "AI 修复：分块 {done} / {total}",
        dustAiLoaded: "AI 修复模型已加载（{provider}）",
        dustAiHint: "笔刷预览仍用 TELEA；检测提交和导出时改用学习型填充。所有计算都在本机完成。",
        exportDng: "导出线性 DNG",
      ...
      en: {
        ...
        dustAiTitle: "AI repair (on-device)",
        ...
        dustAiStatusIdleGpu: "No model loaded. Tick AI repair or load a model; this machine has WebGPU and will run it there.",
        ...
        dustAiStatusError: "Model failed: {message}. Load a LaMa ONNX file instead.",
        dustAiStatusRunning: "AI repair: tile {done} / {total}",
        dustAiLoaded: "AI repair model loaded ({provider})",
        dustAiHint: "Brush strokes preview with TELEA; the learned fill replaces it when detection commits and on export. Nothing leaves the device.",
      ...
      ja: {
        ...
        exportJpeg: "JPEG出力",
        exportTiff: "TIFF出力",
        dustAiTitle: "AI 修復（端末内で実行）",
        dustAiEnable: "確定と書き出し時に学習済みインペインタでマスクを埋める",
        dustAiLoad: "モデルを読み込む",
        dustAiPick: "モデルファイルを使う（.onnx）",
        dustAiStatusIdleGpu: "モデル未読み込み。AI 修復をオンにするかモデルを読み込んでください。この端末は WebGPU で実行します。",
        ...
        dustAiStatusError: "モデルの読み込みに失敗：{message}。LaMa の ONNX ファイルを読み込んでください。",
        dustAiStatusRunning: "AI 修復：タイル {done} / {total}",
        dustAiLoaded: "AI 修復モデルを読み込みました（{provider}）",
        dustAiHint: "ブラシのプレビューは TELEA のまま。検出の確定と書き出しでは学習済みの補完に置き換わります。すべて端末内で処理します。",
